...
module.exports = {
    print: async (page) => {
        ...
        console.log("Menyimpan List SKPD Persetujuan Depan .....")
        fs.writeFile(`${PATH.DPA.JSON}\\persetujuanDepan.json`, JSON.stringify(listCetakSKPD), function(err) { 
            if (err) {
                console.log('File JSON tidak bisa disimpan', err)
            }
            console.log('List SKPD Persetujuan Depan Berhasil Disimpan')
        });
    },
};