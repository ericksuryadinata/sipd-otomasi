...
module.exports = {
    getLink: async (page, listSKPDLengkap) => {
        ...
        this.download(listCetakSKPD, listSKPDLengkap);
    },
    
    download: async (listSKPD, listSKPDLengkap) => {
        ...
        for (const [index, skpd] of listSKPDLengkap.entries()) {
            ...
            let file = `${PATH.DPA.PERSETUJUANDEPAN}\\${namaSKPD}.pdf`
