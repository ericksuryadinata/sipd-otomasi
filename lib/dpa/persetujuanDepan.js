...
module.exports = {
    ...
    download: async (listSKPD) => {
        ...
        let link = `https://burukab.sipd.kemendagri.go.id/siap/dpa-biaya/cetak?Jz0TCcwrJQcMu@5DQeBaSNdRX5Sdhyt8e2t14KXvR35H1GJInIoIcH9RKkK4tp06sT@yom9pq8ybWH8olFH2UTtym18pfeEcL14qLrLVMc81dgF2ZRMw7EKnYZ@KQNJ5DwxcZJ40YfDSBbks/Hx/aHe4MwD85EJZr4JEswlhk0A=`

        let res = await ax.get(link,{
            responseType:"stream"
        })

        await res.data.pipe(fs.createWriteStream(`${PATH.DPA.JSON}\\test.pdf`))
